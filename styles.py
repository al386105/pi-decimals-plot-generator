...
mpi_algorithms_excluded = ['GMP-CHD-SME-BLC']
omp_algorithms_included = ['GMP-BBP-BLC', 'GMP-BEL-BSP-CYC', 'GMP-CHD-SME-SNK', 'GMP-CHD-CWE-SEQ', 'MPFR-BBP-BLC', 'MPFR-BEL-BSP-CYC', 'MPFR-CHD-SME-BLC', 'MPFR-CHD-CWE-SEQ',]

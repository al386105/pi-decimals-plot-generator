...
def get_execution_times_latex_table(results):
    ...
    latex_table = "\\begin{table}[H]\n" \
                  ...
                  "\t\\cline{2-8} \n" \
                  "\t\\multirow{-2}{*}{\\cellcolor{Grey}\\textbf{Algoritmo}} & \\multicolumn{1}{c|}{\\textbf{1}} & \\multicolumn{1}{c|}{\\textbf{10}} & \\multicolumn{1}{c|}{\\textbf{40}} & \\multicolumn{1}{c|}{\\textbf{80}} & \\multicolumn{1}{c|}{\\textbf{120}} & \\multicolumn{1}{c|}{\\textbf{160}} & \\textbf{200} \\\\\n " \
                  "\t\\hline\n" \
                  + data_rows + \
                  "\\end{tabular}\n" \
                  "\\end{center}\n" \
